...
<!-- begin markup for log page -->
    <div id="capture-log">
        ...
        <form method="get" action='<?php echo admin_url("admin.php") ?>'>
            ...
            <input type="search" name="keyword" class="table-filter" data-table="order-table" placeholder="Search" value="<?=isset($_GET['keyword']) ? $_GET['keyword'] : ''?>"/>
            ...
            <a id="export" target="_blank" class="button" href="<?=admin_url('admin-post.php?action=sfc_export&keyword=' . $_GET['keyword'] . '&show_all=' . ($show_all ? 1 : 0))?>">Export</a>
        </form>
        ...
        <div id="dataTable">
            ...
            if (isset($_GET['keyword'])) {
                ...
                $query .= " AND (fc_request_data LIKE '%$kw%' OR fc_response LIKE '%$kw%')";
            }
